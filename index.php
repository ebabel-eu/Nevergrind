	...
	<div id="window2">
		...
		<div id="gameView">
			...
			<div id="characterSelectScreen">
				...
				<?php
						echo 
						'<a target="_blank" href="/store.php">
							<div id="showCrystals" class="fire strongShadow2 NGgradient">
							<div class="crystals crystals2 pointer"></div>
							Buy Crystals
						</div>
							</a>';
				...
				<div id="rightPaneBG">
					<nav id="nglogo" class="strongShadow">
						...
						<a id="reddit" target="_blank" href="https://reddit.com/r/nevergrind" class="social-wrap"></a>
						<a id="linkedin" target="_blank" href="https://goo.gl/BFsmf2" class="social-wrap"></a>
						<hr class="fancyHR">
						<?php
